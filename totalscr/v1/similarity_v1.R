...
save(user.scores.prod, file = 'features/user_scores_prod.Rdata')

## 2. Category Type
# Get affinity user-item matrix
user.scores.cat_lenstype <- getAffinityMatrix(data.purchase = purchase_cat_final)
save(user.scores.cat_lenstype, file = 'features/user_scores_cat_lenstype.Rdata')

## 3. Category Brand
# Get affinity user-item matrix
user.scores.cat_brand <- getAffinityMatrix(data.purchase = purchase_brand_final)
save(user.scores.cat_brand, file = 'features/user_scores_cat_brand.Rdata')

## 4. Category Manufacturer
# Get affinity user-item matrix
user.scores.cat_manu <- getAffinityMatrix(data.purchase = purchase_manu_final)
save(user.scores.cat_manu, file = 'features/user_scores_cat_manu.Rdata')

## 5. Category Type Manufacturer
# Get affinity user-item matrix
user.scores.cat_lenstypemanu <- getAffinityMatrix(data.purchase = purchase_cat_manu_final)
save(user.scores.cat_lenstypemanu, file = 'features/user_scores_cat_lenstypemanu.Rdata')

## 6. Sub Category Type
# Get affinity user-item matrix
user.scores.subcat_lenstype <- getAffinityMatrix(data.purchase = purchase_sub_cat_final)
save(user.scores.subcat_lenstype, file = 'features/user_scores_subcat_lenstype.Rdata')

## 7. Sub Category Brand
# Get affinity user-item matrix
user.scores.subcat_brand <- getAffinityMatrix(data.purchase = purchase_sub_brand_final)
save(user.scores.subcat_brand, file = 'features/user_scores_subcat_brand.Rdata')

## 8. Sub Category Manufacturer
# Get affinity user-item matrix
user.scores.subcat_manu <- getAffinityMatrix(data.purchase = purchase_sub_manu_final)
save(user.scores.subcat_manu, file = 'features/user_scores_subcat_manu.Rdata')

## 9. Category Type Manufacturer
# Get affinity user-item matrix
user.scores.subcat_lenstypemanu <- getAffinityMatrix(data.purchase = purchase_sub_cat_manu_final)
save(user.scores.subcat_lenstypemanu, file = 'features/user_scores_subcat_lenstypemanu.Rdata')

## 10. Sub Category
# Get affinity user-item matrix
user.scores.subcat <- getAffinityMatrix(data.purchase = purchase_sub_final)
save(user.scores.subcat, file = 'features/user_scores_subcat.Rdata')
